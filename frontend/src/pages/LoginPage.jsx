      ...
      <div className="auth-left">
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <div className="flex items-center gap-3" style={{ marginBottom: 64 }}>
            <div style={{
              width: 44, height: 44, background: 'var(--grad-brand)',
              borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: '1.3rem', boxShadow: 'var(--shadow-brand)'
            }}>🧠</div>
            <span style={{
          ...
          <h2 style={{ marginBottom: 16, fontFamily: 'var(--font-display)', fontSize: '2.2rem', fontWeight: 800 }}>
            AI-assisted<br />hiring intelligence
          </h2>
          <p style={{ color: 'var(--text-secondary)', marginBottom: 48, lineHeight: 1.7, maxWidth: 360 }}>
      ...
      <div className="auth-right">
        <div className="auth-form-card">
            ...
            {['recruiter', 'candidate'].map(r => (
              <button
                ...
                style={{
                  ...
                  border: role === r ? '1px solid var(--border-brand)' : '1px solid var(--border-subtle)',
                  background: role === r ? 'rgba(61,110,255,0.12)' : 'transparent',
                  color: role === r ? 'var(--brand-400)' : 'var(--text-muted)',
                  fontWeight: 600, fontSize: '0.85rem',
                  cursor: 'pointer', transition: 'all 0.2s',
                  display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8
                }}
              >
                {r === 'recruiter' ? '💼' : '👤'} {r.charAt(0).toUpperCase() + r.slice(1)}
              </button>
            ))}
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: 10, fontWeight: 600 }}>
